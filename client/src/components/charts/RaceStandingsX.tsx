...
import { RaceStandingsXX } from '../../constants/RaceStandingsX'
  ...
  return (
    ...
    >
       <Typography fontSize={16} color="black" fontWeight={700} mt={0}>
        ...
        <Stack my="5px" direction="column" gap={2.5}>
            {RaceStandingsXX.map((bar)=> <ProgressBar key={bar.title}{...bar} maxPoints={maxPoints}/>)}
        </Stack>
    </Box>
  )
}
